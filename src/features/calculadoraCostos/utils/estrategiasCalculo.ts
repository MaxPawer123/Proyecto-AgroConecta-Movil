...
const UNIDAD_POR_CATEGORIA: Record<string, UnidadCategoria> = {
  ...
  'Mano de obra para roturar': 'trabajo de personas (jornal)',
  'Mano de obra para siembra': 'trabajo de personas (jornal)',
  'Abonos': 'kg',
  'Pesticidas': 'kg',
  'Agua/Riego': 'hora',
  'Fertilizantes químicos': 'kg',
  'Fertilizantes orgánicos': 'kg',
  'Mano de obra para labores culturales': 'trabajo de personas (jornal)',
  'Maquinaria para Cosecha': 'hora',
  'Mano de obra para cosecha': 'trabajo de personas (jornal)',
  'Transporte': 'viaje',
  'Herramientas': 'unidad',
  'Otros': 'unidad',
};
